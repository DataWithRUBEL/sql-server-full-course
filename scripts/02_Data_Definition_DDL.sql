-- DDL-এর মূল কাজ হলো database structure তৈরি ও পরিবর্তন করা।
CREATE  → Structure তৈরি
ALTER   → Structure পরিবর্তন
DROP    → Structure মুছে ফেলা 


এখন CREATE-এর আসল বিষয়
...
ALTER TABLE — Structure পরিবর্তন
...
SELECT
    ...
    Phone
FROM Customers;
কারণ existing data যদি নতুন datatype-এর সাথে compatible না হয়, তাহলে alteration fail করতে পারে।
...
কিন্তু আমাদের ক্ষেত্রে DROP করা যাবে না ⚠️
...
DROP বনাম DELETE বনাম TRUNCATE
...
1️⃣ CREATE — Database/Table তৈরি 🏗️
🎯 কী কাজ করে?
...
5️⃣ UPDATE — Existing Data পরিবর্তন ✏️
...
8️⃣ TRUNCATE — পুরো Table Empty করা 🧹
...
9️⃣ TRUNCATE কেন Staging-এ বেশি ব্যবহার হয়? 🔄
ধরুন:
Day 1 CSV
   ↓
StagingSales
...
1️⃣1️⃣ DROP — Object পুরোপুরি Remove 💣
